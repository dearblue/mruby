MRuby::Toolchain.new(:visualcpp) do |conf, _params|
  conf.cc do |cc|
    ...
    cc.flags = [ENV['CFLAGS'] || %w(/c /nologo /W3 /w34668 /we4013 /Zi /MD /O2 /D_CRT_SECURE_NO_WARNINGS)]
  ...
  conf.cxx do |cxx|
    ...
    cxx.flags = [ENV['CXXFLAGS'] || ENV['CFLAGS'] || %w(/c /nologo /W3 /w34668 /Zi /MD /O2 /EHs /D_CRT_SECURE_NO_WARNINGS)]
